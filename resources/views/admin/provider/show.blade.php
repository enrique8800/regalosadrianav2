    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{$provider->razon_social}}</li>
            </ol>
        </nav>
    </div>
    <div class="row">
                            ...
                            <div class="profile-feed">
                                <div class="d-flex align-items-start profile-feed-item">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <hr>
                                        <strong><i class="fas fa-address-card mr-1"></i> Código postal</strong>
                                        <p class="text-muted">
                                            {{$provider->cp}}
                                        </p>
                                        <hr>
